      ...
      >
        ...
        <ul className="nav flex-column p-3">
          <li className="nav-item mb-3">
            <button
              onClick={() => onClick("main-content")}
              className="nav-link text-primary d-flex align-items-center fs-5"
            >
          ...
          <li className="nav-item mb-3">
            <button
              onClick={() => onClick("create-quotation")}
              className="nav-link text-primary d-flex align-items-center fs-5"
            >
          ...
          <li className="nav-item mb-3">
            <button
              onClick={() => onClick("view-quotation")}
              className="nav-link text-primary d-flex align-items-center fs-5"
            >
          ...
          <li className="nav-item mb-3">
            <button
              onClick={goto}
              className="nav-link text-danger d-flex align-items-center fs-5"
            >
